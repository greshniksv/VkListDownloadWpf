...
namespace VkListDownloader2
{
    public class LinkDownloader
    {
        ...
        private readonly Dictionary<string, Uri> _linkDictionary;
        private readonly string _workDirectory;
        private readonly int _retryCount;
        private readonly Dictionary<string, Uri> _skipedList = new Dictionary<string, Uri>();
        ...
        public event Action<Dictionary<string, Uri>> Complete;
        
        public LinkDownloader(int threadCount, int retryCount,
                string workDirectory, Dictionary<string, Uri> linkDictionary)
        {
        ...
        private void Work()
        {
            ...
            foreach (var link in _linkDictionary)
            {
                ...
                KeyValuePair<string, Uri> link1 = link;
        ...
        private void Downloaded(string name, Uri url)
        {
